...
case ",$TEST," in
  *,upload,*|*,download_cold,*|*,download_warm,*|*,lookup_latency,*|*,lookup_complexity,*|*,replication,*|*,replication_distribution,*|*,repair_time,*|*,network_hops,*|*,routing_overhead,*|*,storage_efficiency,*|*,concurrent,*) ;;
  *)
