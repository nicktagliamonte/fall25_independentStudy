...
export AVAILABILITY_MIN_MATCHES=${AVAILABILITY_MIN_MATCHES:-}
...
campaign_capture_host_manifest "$run_dir/host.json"
{
  ...
  echo "AVAILABILITY_MIN_MATCHES=$AVAILABILITY_MIN_MATCHES"
  echo "TARSUS_MIN_OUTBOUND=$TARSUS_MIN_OUTBOUND"
  echo "TARSUS_MAX_CONNECTIONS=$TARSUS_MAX_CONNECTIONS"
